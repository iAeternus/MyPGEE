...
11. 双阶乘
    ...
    * 偶数的双阶乘：$(2n)!! = 2 \cross 4 \cross 6 \cross \dots \cross 2n = 2^n n!$
    * 奇数的双阶乘：$(2n - 1)!! = 1 \cross 3 \cross 5 \cross \dots \cross (2n - 1) = \cfrac{(2n)!}{2^nn!}$
    * 
...
1. 寻找渐近线的程序
   ...
   * 若 $\lim\limits_{x \to \infty} f(x) = \infty$，则判断若 $\lim\limits_{x \to \infty} \cfrac{f(x)}{x} = a \ne 0$，求出 $b = \lim\limits_{x \to \infty} [f(x) - ax]$，当 $a$、$b$ 都存在时，则存在斜渐近线，否则没有斜渐近线
...
![](F:/documents/MyPGEE/main/math/notes/数学笔记/assets/旋转体体积例题.jpg)
